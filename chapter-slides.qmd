...
## Pharmacokinetics and Pharmacodynamics <br> of Antiinfective Agents {background-color="#9B0014"}
...
<br> <br> **Clinical significance:** - Prolongs drug elimination - Antibiotics disrupting gut flora can interrupt this cycle - Important for: β-lactams, mycophenolic acid, oral contraceptives
...
![](images/ODA.png){fig-align="center"}
...
<iframe src="images/infusion_strategy.html" width="100%" height="750px" 
        style="border:none; background:transparent; transform: scale(1.3); transform-origin: top center; margin-bottom: 225px;"></iframe>
...
<iframe src="images/loadingdose.html" width="100%" height="750px" 
        style="border:none; background:transparent; transform: scale(1.5); transform-origin: top center; margin-bottom: 375px;"></iframe>
...
::: aside
[@Rhodes2018; @Falagas2013; @Dulhunty2015; @AbdulAziz2016]
:::
