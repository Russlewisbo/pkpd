...
## Pharmacokinetics and Pharmacodynamics <br> of Anti-infective Agents {background-color="#9B0014"}
...
<br> slides available at: www.idpadova.com

</center>

|  |  |
|-----------------------------------|-------------------------------------|
| ![](images/dmmunipd_logo.jpeg){width="150"} | ![](images/unipd_seal_white.svg){width="150"} |
...
A 65-year-old man with *Pseudomonas aeruginosa* pneumonia is started on piperacillin-tazobactam 4.5g IV q8h. <br> On day 3, he's not improving. The MIC comes back as 16 mg/L (susceptible breakpoint).
...
<iframe src="enterohepatic.html" width="70%" height="300px" style="border: none; transform: scale(1.5); transform-origin: top center; margin-bottom: 120px;" sandbox="allow-same-origin allow-scripts allow-downloads allow-forms">

</iframe>
:::

<br> <br> **Clinical significance:**
...
::: aside
Volume of distribution is a key concept that is often misunderstand. It's not a real volume—it's a mathematical relationship. A drug with Vd of 500 L isn't really distributed in 500 liters; it means the drug is extensively bound in tissues, leaving low plasma concentrations. Aminoglycosides have small Vd (stay in ECF); macrolides and tetracyclines have huge Vd (accumulate in tissues).
:::
...
**Only UNBOUND drug is pharmacologically active!** <br>
...
<iframe src="cyp3a4_boosting.html" width="100%" height="400px" style="border: none; transform: scale(2.0); transform-origin: top center; margin-bottom: 300px;" sandbox="allow-same-origin allow-scripts allow-downloads allow-forms">

</iframe>

<br> **Examples of boosted regimens:**
...
![](images/pkdp_index.png){fig-align="center"}

# PART 2: APPLICATIONS {background-color="#9B0014"}
...
![](images/pkpdanimal.png){fig-align="center"}
...
![](images/clipboard-406664738%20copy.png){fig-align="center"}
...
| Fluoroquinolones | AUC/MIC (or C~max~/MIC) | 30-50 (Gram+), <br>100-125 (Gram-) |
...
digraph G {
  ...
  A [label="In Vitro"            fillcolor="#90EE90"]
  B [label="Animal Models"       fillcolor="#87CEEB"]
  C [label="Phase I/II Trials"   fillcolor="#DDA0DD"]
  D [label="Phase III/Clinical Use" fillcolor="#F0E68C"]
...
![](images/invitromodel.png){fig-align="center"}

## Hollow fiber infection model

![](images/invitromodel2.png){fig-align="center"}
...
![](images/ODA.png){fig-align="center" width="800"}
...
<center>Three approaches:</center>
...
<iframe src="images/infusion_strategy.html" width="100%" height="750px" style="border:none; background:transparent; transform: scale(1.3); transform-origin: top center; margin-bottom: 225px;">
...
<iframe src="images/loadingdose.html" width="100%" height="750px" style="border:none; background:transparent; transform: scale(1.5); transform-origin: top center; margin-bottom: 375px;">
...
::: aside
Critically ill patients are the hardest to dose. Early in sepsis, volume expands dramatically, diluting drugs. ARC (GFR \>130 mL/min) is common in young septic patients—they clear drugs faster than normal. Then organ failure develops and clearance drops. Standard doses often fail to achieve targets. This population benefits most from TDM and individualized dosing. [@roberts.etal_2014c]
:::

# Therapeutic Drug Monitoring: <br>Key Principles {background-color="#9B0014"}

## When is TDM valuable? <br>
...
::: aside
Azole antifungals have highly variable PK making TDM valuable. Voriconazole is metabolized by polymorphic CYP2C19—poor metabolizers can have toxic levels on standard doses. Posaconazole suspension requires high-fat meal for absorption. Newer formulations (tablets, IV- if avaialable) are more reliable. For serious fungal infections, TDM helps ensure adequate exposure.
:::
...
::: aside
Aminoglycosides: once-daily. β-lactams: extended infusion when needed. Vancomycin: AUC-based dosing. Azoles: TDM. These principles apply across most clinical situations. Adapt based on organism MIC and patient factors.
:::
