...
```{dot}
//| label: fig-pkpd-framework
//| fig-cap: "Conceptual framework relating pharmacokinetics and pharmacodynamics to clinical outcomes."
digraph G {
...
```{dot}
//| label: fig-pk-pd-process
//| fig-cap: "The pharmacokinetic–pharmacodynamic process from dosing regimen to antimicrobial effect [@craig_1998]."
digraph G {
  rankdir=LR
  fontname="Helvetica,Arial,sans-serif"
  node [fontname="Helvetica,Arial,sans-serif"]
  ...
  PD2       [shape=rectangle, label="Antimicrobial effect\nvs. time"];
}
```
...
![Simulated serum concentration-time profile illustrating key pharmacokinetic parameters.](images/AUC.png){#fig-concentration-time fig-align="center"}

![Steady-state drug accumulation with repeated dosing. Steady state is reached after approximately 4–5 half-lives.](images/steadystate.png){#fig-steady-state fig-align="center"}

![The four pillars of pharmacokinetics: Absorption, Distribution, Metabolism, and Elimination (ADME).](images/adme_diagram.png){#fig-adme fig-align="center" width="700"}
...
<iframe src="enterohepatic.html" width="100%" height="450px" style="border: none;">
</iframe>
...
<iframe src="cyp3a4_boosting.html" width="100%" height="450px" style="border: none;">
</iframe>
...
![Common PK-PD indices for antiinfective agents: C~max~/MIC, AUC/MIC, and T > MIC.](images/pkdp_index.png){#fig-pkpd-indices fig-align="center"}
...
::: {layout-ncol=2}
![Hollow fiber infection model schematic.](images/invitromodel.png){#fig-hfim-1}

![Hollow fiber cartridge detail showing extracapillary space where organisms are cultured.](images/invitromodel2.png){#fig-hfim-2}
:::
...
::: {layout-ncol=2}
![PK-PD indices from animal infection models: cefotaxime against *S. pneumoniae* [@craig_1998].](images/pkpdanimal.png){#fig-animal-model}

![Comparison of ciprofloxacin PK-PD relationships in mice versus humans [@craig_1998].](images/clipboard-406664738 copy.png){#fig-cipro-pkpd}
:::
...
![Hartford nomogram for extended-interval aminoglycoside TDM. Trough levels drawn 6–14 hours post-dose are plotted to determine dosing interval [@nicolau.etal_1995].](images/ODA.png){#fig-oda-nomogram fig-align="center" width="700"}
...
<iframe src="images/infusion_strategy.html" width="100%" height="500px" style="border: none;">
</iframe>
...
<iframe src="images/loadingdose.html" width="100%" height="500px" style="border: none;">
</iframe>
